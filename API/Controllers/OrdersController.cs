...
namespace API.Controllers
{
    ...
    public class OrdersController : BaseController
    {
        ...
        [HttpPost]
        public async Task<ActionResult<int>> CreateOrderAsync(CreateOrderDto orderDto)
        {
            ...
            if (result) return CreatedAtRoute("GetOrderByIdAsync", new { id = order.Id }, order.Id);

            return BadRequest(new ProblemDetails { Title = "Problem creating order", Status = 400 });
        }
    }
}